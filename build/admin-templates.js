...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  },hashTypes:{'id': "ID",'hashedEmail': "ID",'about': "ID",'image': "ID",'isProfileEditingOnForProfileSetting': "ID"},hashContexts:{'id': depth0,'hashedEmail': depth0,'about': depth0,'image': depth0,'isProfileEditingOnForProfileSetting': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "prof-setting", options))));
  data.buffer.push("\r\n</div>");
  return buffer;
